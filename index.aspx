            ...
            <div class="layui-layout layui-layout-admin">
                ...
                <div class="layui-side layui-side-menu">
                    <div class="layui-side-scroll">
                        <div class="layui-logo" lay-href="home/home.aspx">
                            <i class="layui-inline layui-icon layui-icon-find-fill"></i>
                            ...
                            <asp:Repeater ID="menuRepeater" runat="server" OnItemDataBound="menuRepeater_ItemDataBound">
                                <ItemTemplate>
                                    <li data-name='<%# Eval("icon") %>' class="layui-nav-item">
                                        ...
                                        <a href="javascript:;" <%# "javascript:;".Equals(Eval("url"))?"":("lay-href="+Eval("url")) %> lay-tips='<%# Eval("name") %>' lay-direction="2">
                ...
                <div class="layadmin-pagetabs" id="LAY_app_tabs">
                    ...
                    <div class="layui-tab" lay-unauto lay-allowclose="true" lay-filter="layadmin-layout-tabs">
                        <ul class="layui-tab-title" id="LAY_app_tabsheader">
                            <li lay-id="home/home.aspx" lay-attr="home/home.aspx" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="layui-body" id="LAY_app_body">
                    <div class="layadmin-tabsbody-item layui-show">
                        <iframe src="home/home.aspx" frameborder="0" class="layadmin-iframe"></iframe>
                    </div>
                </div>
