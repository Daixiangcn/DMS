<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Donate.admin.management.Types" %>
                ...
                <div class="layui-card-body" style="padding: 15px;">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="layui-table" DataKeyNames="id" DataSourceID="SqlDataSource1">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="类别描述" SortExpression="description">
                                <EditItemTemplate>
                    ...
                    <br />
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DonateConnectionStrings %>" ProviderName="<%$ ConnectionStrings:DonateConnectionStrings.ProviderName %>" SelectCommand="SELECT * FROM typeInfo" UpdateCommand="UPDATE typeInfo SET name = @name, description = @description WHERE (id = @id)" DeleteCommand="DELETE FROM typeInfo WHERE id= @id" InsertCommand="INSERT INTO typeInfo(name, description) VALUES (@name, @description)"></asp:SqlDataSource>
                </div>
            </div>
        </form>
    </div>
