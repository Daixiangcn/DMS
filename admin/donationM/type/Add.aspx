            ...
            <div class="layui-card">
                <div class="layui-card-body" style="padding: 15px;">
                    <div class="layui-form-item">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" Display="Dynamic" ErrorMessage="类别名称不能为空" ForeColor="Red" ValidationGroup="add"></asp:RequiredFieldValidator>
                        <div class="layui-form-item">
